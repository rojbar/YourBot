...
read.setName('read');
read.setDescription('Starts reading a manga that is in your library');
read.setHasArgs(true);	
read.setUsage('command <manga-name>');
read.setCooldown(5);


read.execute = async function(message,args)
{
